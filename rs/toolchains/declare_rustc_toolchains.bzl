    ...
    for triple in exec_triples:
        ...
        rust_toolchain_kwargs = dict(
            ...
            extra_exec_rustc_flags = select({
                "@rules_rs//rs/platforms/config:riscv32imac-unknown-none-elf": [],
                "@rules_rs//rs/platforms/config:riscv32imc-unknown-none-elf": [],
                "@platforms//cpu:wasm32": [],
                "@platforms//cpu:wasm64": [],
                "//conditions:default": ["-Clink-self-contained=no"],
